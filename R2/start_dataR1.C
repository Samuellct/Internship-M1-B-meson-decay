{
    TChain *mytree = new TChain("DecayTree");    
    //mytree->Add("DATAkpipipi0G_SELkpipipi0G_MagDown-2011-S21r1p2_red.root"); \\corrompu
    mytree->Add("DATAkpipipi0G_SELkpipipi0G_MagUp-2011-S21r1p2_red.root");
    mytree->Add("DATAkpipipi0G_SELkpipipi0G_MagDown-2012-S21r0p2_red.root");
    mytree->Add("DATAkpipipi0G_SELkpipipi0G_MagUp-2012-S21r0p2_red.root");
	...
	HLT1TOS = TCut("(B_Hlt1TrackAllL0Decision_TOS || B_Hlt1TrackPhotonDecision_TOS)");
	...
	//mytree->Draw("B_M",massCuts && L0TOS&& HLT1TOS && HLT2TOS && ChargedPIDcut && NeutralPIDcut)
}
